...
const MESSAGES: Record<Locale, Record<string, string>> = {
  sv: {
    ...
    "quality.class.label": "EU-klassning {year}",
    "quality.class.0": "Ej klassificerad",
    "quality.class.1": "Utmärkt kvalitet",
    "quality.class.2": "Bra kvalitet",
    "quality.class.3": "Tillfredsställande kvalitet",
    "quality.class.4": "Dålig kvalitet",
    "quality.class.6": "Ny badplats",
    "quality.advisory.title": "Avrådan från bad",
    "quality.advisory.type.1": "Otjänligt badvattenprov",
    "quality.advisory.type.99": "Avrådan hela badsäsongen",
    "quality.advisory.type.default": "Avrådan",
    "quality.advisory.since": "sedan {date}",
    "about.data.maps":
  ...
  en: {
    ...
    "quality.class.label": "EU rating {year}",
    "quality.class.0": "Not classified",
    "quality.class.1": "Excellent quality",
    "quality.class.2": "Good quality",
    "quality.class.3": "Sufficient quality",
    "quality.class.4": "Poor quality",
    "quality.class.6": "New bathing site",
    "quality.advisory.title": "Bathing advisory",
    "quality.advisory.type.1": "Unfit water sample",
    "quality.advisory.type.99": "Advised against all season",
    "quality.advisory.type.default": "Advisory",
    "quality.advisory.since": "since {date}",
    "about.data.meteo":
