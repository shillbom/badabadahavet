...
const MESSAGES: Record<Locale, Record<string, string>> = {
  sv: {
    ...
    "history.streak.empty": "Ingen aktiv svit just nu — bada idag eller igår för att starta en.",
    ...
    "log.field.when": "När",
    "log.field.when.now_hint": "Logger automatiskt med just nu — växla till välj plats för att ändra.",
    ...
    "log.bracket.B": "Skärsäsong (apr & okt)",
    ...
    "profile.delete.confirm": "Det här tar bort dig, alla dina bad, foton och gruppmedlemskap. Det går inte att ångra.",
