...
const MESSAGES: Record<Locale, Record<string, string>> = {
  sv: {
    ...
    "install.ios.title": "Lägg till Badligan på hemskärmen",
    "install.ios.body":
      "Tryck på Dela-ikonen i Safari och välj “Lägg till på hemskärmen”.",
    "install.ios.dismiss": "Inte nu",
    ...
    "leaderboard.global_toggle": "Global topplista",
    "leaderboard.year_prev": "Föregående år",
    "leaderboard.year_next": "Nästa år",
    ...
    "groups.timespan.add": "Lägg till en tävlingsperiod",
    "groups.timespan.optional_hint":
      "Valfritt. Topplistan räknar bara bad inom perioden.",
    "groups.timespan.start": "Start",
    "groups.timespan.end": "Slut",
    "groups.timespan.clear": "Rensa",
    "groups.timespan.invalid": "Slutdatum måste vara efter startdatum",
    "groups.timespan.open_start_label": "Till",
    "groups.timespan.open_end_label": "Från",
    "groups.settings.title": "Gruppinställningar",
    "groups.settings.open": "Inställningar",
    "groups.settings.saved": "Sparat",
    "groups.settings.saved_action": "Spara period",
    "groups.settings.manage_members": "Hantera medlemmar",
    "groups.settings.timespan": "Tävlingsperiod",
    ...
    "log.field.water_temp": "Vattentemperatur",
    "log.field.water_temp.placeholder": "t.ex. 18.5",
    "log.field.water_temp.hint": "Angiven temperatur uppdaterar badplatsen",
    "log.field.water_temp.add": "Ange temperatur",
    "log.field.water_temp.set": "Klar",
    "log.field.water_temp.clear": "Rensa",
    "log.field.water_temp.current": "Nuvarande: {temp}°C",
    ...
    "temp.source.user": "Rapporterad av badare",
    "spot.temp.source": "Källa: {source}",
    "spot.temp.graph_title": "Temperaturhistorik",
    "spot.temp.graph_avg": "Medel: {temp}°C",
    "spot.temp.graph_nodata": "Ingen temperaturhistorik än",
    "spot.temp.history_days": "Senaste 30 dagarna",
    "spot.temp.show_history": "Visa historik",
    "spot.temp.hide_history": "Dölj historik",
    ...
    "profile.password.title": "Byt lösenord",
    "profile.password.current": "Nuvarande lösenord",
    "profile.password.new": "Nytt lösenord",
    "profile.password.save": "Uppdatera lösenord",
    "profile.password.saved": "Lösenord uppdaterat",
    "profile.password.current_required": "Skriv ditt nuvarande lösenord",
    "profile.password.current_wrong": "Nuvarande lösenord är fel",
    "profile.password.relogin":
      "Bekräfta ditt nuvarande lösenord och försök igen.",
  ...
  en: {
    ...
    "install.ios.title": "Add Badligan to your home screen",
    "install.ios.body":
      "Tap the Share icon in Safari and choose “Add to Home Screen”.",
    "install.ios.dismiss": "Not now",
    ...
    "leaderboard.global_toggle": "Global top list",
    "leaderboard.year_prev": "Previous year",
    "leaderboard.year_next": "Next year",
    ...
    "groups.timespan.add": "Add a competition window",
    "groups.timespan.optional_hint":
      "Optional. The leaderboard only counts swims inside the window.",
    "groups.timespan.start": "Start",
    "groups.timespan.end": "End",
    "groups.timespan.clear": "Clear",
    "groups.timespan.invalid": "End date must be after the start date",
    "groups.timespan.open_start_label": "Until",
    "groups.timespan.open_end_label": "From",
    "groups.settings.title": "Group settings",
    "groups.settings.open": "Settings",
    "groups.settings.saved": "Saved",
    "groups.settings.saved_action": "Save window",
    "groups.settings.manage_members": "Manage members",
    "groups.settings.timespan": "Competition window",
    ...
    "log.field.water_temp": "Water temperature",
    "log.field.water_temp.placeholder": "e.g. 18.5",
    "log.field.water_temp.hint": "Reported temperature updates the spot",
    "log.field.water_temp.add": "Set temperature",
    "log.field.water_temp.set": "Done",
    "log.field.water_temp.clear": "Clear",
    "log.field.water_temp.current": "Current: {temp}°C",
    ...
    "temp.source.user": "Reported by swimmer",
    "spot.temp.source": "Source: {source}",
    "spot.temp.graph_title": "Temperature history",
    "spot.temp.graph_avg": "Avg: {temp}°C",
    "spot.temp.graph_nodata": "No temperature history yet",
    "spot.temp.history_days": "Last 30 days",
    "spot.temp.show_history": "Show history",
    "spot.temp.hide_history": "Hide history",
    ...
    "profile.password.current_wrong": "Current password is incorrect",
    "profile.password.relogin": "Confirm your current password and try again.",
